...
val Bluetooth.permissionsNeeded: Array<String> by lazy {
    when {
        ...
        SDK_INT <= P -> arrayOf(ACCESS_COARSE_LOCATION)
        ...
        // https://developer.android.com/guide/topics/connectivity/bluetooth/permissions#declare-android11-or-lower
        SDK_INT <= R -> arrayOf(ACCESS_FINE_LOCATION)
        ...
        else /* SDK_INT >= S */ -> arrayOf(BLUETOOTH_SCAN, BLUETOOTH_CONNECT)
    }
}
